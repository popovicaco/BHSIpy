...
class UNet_plus_plus:
  ...
  def build_3d_unet_plus_plus(self):
    ...
    # L1
    down_sampling_pooling_layer_1, encoding_space_layer_1 = self.encoding_layers_building_blocks(32, input_layer)
    down_sampling_pooling_layer_2, encoding_space_layer_2 = self.encoding_layers_building_blocks(64, down_sampling_pooling_layer_1)
    up_output_1 = self.decoding_layers_building_blocks(32, encoding_space_layer_2, encoding_space_layer_1)
    
    # L2
    down_sampling_pooling_layer_3, encoding_space_layer_3 = self.encoding_layers_building_blocks(128, down_sampling_pooling_layer_2)
    up_output_22 = self.decoding_layers_building_blocks(64, encoding_space_layer_3, encoding_space_layer_2)
    concat_layer_21 = concatenate([encoding_space_layer_1, up_output_1], axis=3)
    up_output_2 = self.decoding_layers_building_blocks(32, up_output_22, concat_layer_21)

    # L3
    down_sampling_pooling_layer_4, encoding_space_layer_4 = self.encoding_layers_building_blocks(256, down_sampling_pooling_layer_3)
    up_output_33 = self.decoding_layers_building_blocks(128, encoding_space_layer_4, encoding_space_layer_3)
    concat_layer_32 = concatenate([encoding_space_layer_2, up_output_22], axis=3)
    up_output_32 = self.decoding_layers_building_blocks(64, up_output_33, concat_layer_32)
    concat_layer_31 = concatenate([encoding_space_layer_1, up_output_1, up_output_2], axis=3)
    up_output_3 = self.decoding_layers_building_blocks(32, up_output_32, concat_layer_31)
    
    # L4
    encoding_space_output_layer = self.encoding_layers_building_blocks(512, down_sampling_pooling_layer_4, pooling_layer=False)
    up_output_44 = self.decoding_layers_building_blocks(256, encoding_space_output_layer, encoding_space_layer_4)
    concat_layer_43 = concatenate([encoding_space_layer_3, up_output_33], axis=3)
    up_output_43 = self.decoding_layers_building_blocks(128, up_output_44, concat_layer_43)
    concat_layer_42 = concatenate([encoding_space_layer_2, up_output_22, up_output_32], axis=3)
    up_output_42 = self.decoding_layers_building_blocks(64, up_output_43, concat_layer_42)
    concat_layer_41 = concatenate([encoding_space_layer_1, up_output_1, up_output_2, up_output_3], axis=3)
    up_output_4 = self.decoding_layers_building_blocks(32, up_output_42, concat_layer_41)
