...
from tensorflow.keras.layers import Input, Reshape, concatenate, Conv2D, MaxPool2D, UpSampling2D, BatchNormalization, Add, Activation, Dropout, Flatten
...
class UNet_2D_plus_plus:
  ...
  def decoding_layers_building_blocks(self, units, in_layer, concat_layer):
      ...
      upsampling_layer = UpSampling2D(size=(2, 2))(in_layer)
  ...
  def build_2d_unet_plus_plus(self):
    '''
    ...
    output_layer_1 = Conv2D(self.utils.n_features, (1, 1))(up_output_1)
    ...
    output_layer_2 = Conv2D(self.utils.n_features, (1, 1))(up_output_2)
    ...
    output_layer_3 = Conv2D(self.utils.n_features, (1, 1))(up_output_3)
    ...
    output_layer_4 = Conv2D(self.utils.n_features, (1, 1))(up_output_4)
  ...
  def train(self):
    ...
    if self.utils.continue_training == True:
        ...
        unet = self.build_2d_unet_plus_plus()
        unet.summary()
